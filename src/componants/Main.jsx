...
const MainPages = () => {
    return (
        <>
            ...
            <section className="py-10 xl:ml-20 lg:ml-14 md:ml-8 xs:ml-4 text-center">
            ...
            <div className="pages 3xl:ml-[959px] 2xl:ml-[864px] md:ml-[384px] xl:ml-[718px] lg:ml-[512px] xs:ml-[215px] s:ml-[187px] a:ml-[159px] bottom-0 left-1/2 transform -translate-x-1/2 flex space-x-2">
                <label htmlFor="slide1" className="3xl:h-5 3xl:w-5 2xl:h-5 2xl:w-5 w-3 h-3 bg-black hover:bg-[#005477] rounded-full cursor-pointer"></label>
                <label htmlFor="slide2" className="3xl:h-5 3xl:w-5 2xl:h-5 2xl:w-5 w-3 h-3 bg-black  hover:bg-[#005477]   rounded-full cursor-pointer"></label>
            </div>
